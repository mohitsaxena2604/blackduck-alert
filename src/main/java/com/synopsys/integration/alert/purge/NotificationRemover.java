...
public class NotificationRemover extends AlertMessageListener<NotificationRemovalEvent> {
    ...
    public NotificationRemover(Gson gson, NotificationRemovalEventHandler eventHandler) {
        super(gson, NotificationRemovalEvent.NOTIFICATION_PURGE_EVENT_TYPE, NotificationRemovalEvent.class, eventHandler);
    }
