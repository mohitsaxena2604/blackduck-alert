...
public class ProxyManagerV2 {
    ...
    private final Logger logger = LoggerFactory.getLogger(ProxyManagerV2.class);

    private final SettingsUtilityV2 settingsUtility;

    @Autowired
    public ProxyManagerV2(SettingsUtilityV2 settingsUtility) {
